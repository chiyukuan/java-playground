 ...
 *
 * Note: The length of both lists will be in the range of [1, 1000]. The length of strings in both lists will be in
 * the range of [1, 30]. The index is starting from 0 to the list length minus 1. No duplicates in
 * both lists.
 *
 * Solution:O(N) maintain index of each restaurant in a list using a HashMap, find the min sum of
