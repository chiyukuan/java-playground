 ...
 * The width at each index is 1. After V units of water fall at index K, how much water is at
 * each index?
 *
 ...
 *      Output: [2,3,3,4]
 *      Explanation: The last droplet settles at index 1, since moving further left would not cause
 ...
 *
 * Solution: Check first left and then right to see if there are any lower levels, if yes then
